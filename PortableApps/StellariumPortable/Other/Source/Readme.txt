...
user in an INI file next to StellariumPortable.exe called 
StellariumPortable.ini. If you are happy with the default options, it is not 
...
StellariumPortable.ini next to StellariumPortable.exe. The options in the 
