...
user in an INI file next to MnemosynePortable.exe called MnemosynePortable.ini.
...
copy AppNamePortable.ini from this directory to MnemosynePortable.ini next to
MnemosynePortable.exe. The options in the INI file are as follows:
