...
user in an INI file next to CelestiaPortable.exe called CelestiaPortable.ini.
...
copy AppNamePortable.ini from this directory to CelestiaPortable.ini next to
CelestiaPortable.exe. The options in the INI file are as follows:
