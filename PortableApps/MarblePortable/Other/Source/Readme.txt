...
user in an INI file next to MarblePortable.exe called MarblePortable.ini. If
...
AppNamePortable.ini from this directory to MarblePortable.ini next to
MarblePortable.exe. The options in the INI file are as follows:
