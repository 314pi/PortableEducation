...
user in an INI file next to SolfegePortable.exe called SolfegePortable.ini.
...
copy AppNamePortable.ini from this directory to SolfegePortable.ini next to
SolfegePortable.exe. The options in the INI file are as follows:
