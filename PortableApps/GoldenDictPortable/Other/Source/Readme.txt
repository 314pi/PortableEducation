...
user in an INI file next to GoldenDictPortable.exe called GoldenDictPortable.ini.
...
copy AppNamePortable.ini from this directory to GoldenDictPortable.ini next to
GoldenDictPortable.exe. The options in the INI file are as follows:
